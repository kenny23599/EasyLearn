import {
  ...
  querystringDecode,
  registerVersion
} from "./chunk-ZVOGNPNV.js";
import {
  require_react
} from "./chunk-S7IG6I2Q.js";
import {
  __toESM
...
var useDeleteUser = (function(auth) {
  ...
  var deleteUser2 = (0, import_react.useCallback)(function() {
    return __awaiter(void 0, void 0, void 0, function() {
      var err_1;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
  ...
  return [deleteUser2, loading, error];
});
var useSendEmailVerification = (function(auth) {
  var _a = (0, import_react.useState)(), error = _a[0], setError = _a[1];
  var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
  var sendEmailVerification$12 = (0, import_react.useCallback)(function() {
    return __awaiter(void 0, void 0, void 0, function() {
      var err_1;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
  ...
  return [sendEmailVerification$12, loading, error];
});
var useSendPasswordResetEmail = (function(auth) {
  var _a = (0, import_react.useState)(), error = _a[0], setError = _a[1];
  var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
  var sendPasswordResetEmail$12 = (0, import_react.useCallback)(function(email, actionCodeSettings) {
    return __awaiter(void 0, void 0, void 0, function() {
      var err_1;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
  ...
  return [sendPasswordResetEmail$12, loading, error];
});
var useSendSignInLinkToEmail = (function(auth) {
  var _a = (0, import_react.useState)(), error = _a[0], setError = _a[1];
  var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
  var sendSignInLinkToEmail$12 = (0, import_react.useCallback)(function(email, actionCodeSettings) {
    return __awaiter(void 0, void 0, void 0, function() {
      var err_1;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
  ...
  return [sendSignInLinkToEmail$12, loading, error];
});
...
var useSignInWithEmailLink = (function(auth) {
  ...
  var _b = (0, import_react.useState)(), loggedInUser = _b[0], setLoggedInUser = _b[1];
  var _c = (0, import_react.useState)(false), loading = _c[0], setLoading = _c[1];
  var signInWithEmailLink$12 = (0, import_react.useCallback)(function(email, emailLink) {
    return __awaiter(void 0, void 0, void 0, function() {
      var user, err_1;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
  ...
  return [signInWithEmailLink$12, loggedInUser, loading, error];
});
...
var useSignOut = (function(auth) {
  var _a = (0, import_react.useState)(), error = _a[0], setError = _a[1];
  var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
  var signOut2 = (0, import_react.useCallback)(function() {
    return __awaiter(void 0, void 0, void 0, function() {
      var err_1;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
...
var useUpdateProfile = function(auth) {
  var _a = (0, import_react.useState)(), error = _a[0], setError = _a[1];
  var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
  var updateProfile$12 = (0, import_react.useCallback)(function(profile) {
    return __awaiter(void 0, void 0, void 0, function() {
      var err_3;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
  ...
  return [updateProfile$12, loading, error];
};
